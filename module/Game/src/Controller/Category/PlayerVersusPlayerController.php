...
class PlayerVersusPlayerController extends AbstractActionController
{
    public function indexAction(): ViewModel
    {
        ...
        $games = CategoryGamesRetriever::execute(new PlayerVersusPlayer(), $sort);

        $form = new SortByForm('grid-sort-by', ['action' => 'player-versus-player', 'sort-by' => $sortBy]);
