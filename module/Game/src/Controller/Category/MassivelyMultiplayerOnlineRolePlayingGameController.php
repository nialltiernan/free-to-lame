...
class MassivelyMultiplayerOnlineRolePlayingGameController extends AbstractActionController
{
    public function indexAction(): ViewModel
    {
        ...
        $games = CategoryGamesRetriever::execute(new MassivelyMultiplayerOnlineRolePlayingGame(), $sort);

        $form = new SortByForm('grid-sort-by', ['action' => 'mmorpg', 'sort-by' => $sortBy]);
