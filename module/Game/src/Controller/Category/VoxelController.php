...
class VoxelController extends AbstractActionController
{
    public function indexAction(): ViewModel
    {
        ...
        $games = CategoryGamesRetriever::execute(new Voxel(), $sort);

        $form = new SortByForm('grid-sort-by', ['action' => 'voxel', 'sort-by' => $sortBy]);
