...
class MassivelyMultiplayerOnlineRealTimeStrategyController extends AbstractActionController
{
    public function indexAction(): ViewModel
    {
        ...
        $games = CategoryGamesRetriever::execute(new MassivelyMultiplayerOnlineRealTimeStrategy(), $sort);

        $form = new SortByForm('grid-sort-by', ['action' => 'mmorts', 'sort-by' => $sortBy]);
