...
class TwoDimensionsController extends AbstractActionController
{
    public function indexAction(): ViewModel
    {
        ...
        $games = CategoryGamesRetriever::execute(new TwoDimensions(), $sort);

        $form = new SortByForm('grid-sort-by', ['action' => 'two-dimension', 'sort-by' => $sortBy]);
