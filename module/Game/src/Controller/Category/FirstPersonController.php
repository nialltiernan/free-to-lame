...
class FirstPersonController extends CategoryController
{
    public function indexAction(): ViewModel
    {
        ...
        $games = CategoryGamesRetriever::execute(new FirstPerson(), $sort);

        return new ViewModel(['games' => $games, 'form' => $this->initSortByForm('first-person', $sortBy)]);
    }
}
