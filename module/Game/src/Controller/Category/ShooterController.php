...
class ShooterController extends AbstractActionController
{
    public function indexAction(): ViewModel
    {
        ...
        $games = CategoryGamesRetriever::execute(new Shooter(), $sort);

        $form = new SortByForm('grid-sort-by', ['action' => 'shooter', 'sort-by' => $sortBy]);
