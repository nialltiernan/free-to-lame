...
class MilitaryController extends AbstractActionController
{
    public function indexAction(): ViewModel
    {
        ...
        $games = CategoryGamesRetriever::execute(new Military(), $sort);

        $form = new SortByForm('grid-sort-by', ['action' => 'military', 'sort-by' => $sortBy]);
