...
class PlayerVersusEnvironmentController extends AbstractActionController
{
    public function indexAction(): ViewModel
    {
        ...
        $games = CategoryGamesRetriever::execute(new PlayerVersusEnvironment(), $sort);

        $form = new SortByForm('grid-sort-by', ['action' => 'player-versus-environment', 'sort-by' => $sortBy]);
