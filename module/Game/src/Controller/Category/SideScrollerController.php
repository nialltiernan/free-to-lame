...
class SideScrollerController extends AbstractActionController
{
    public function indexAction(): ViewModel
    {
        ...
        $games = CategoryGamesRetriever::execute(new SideScroller(), $sort);

        $form = new SortByForm('grid-sort-by', ['action' => 'side-controller', 'sort-by' => $sortBy]);
