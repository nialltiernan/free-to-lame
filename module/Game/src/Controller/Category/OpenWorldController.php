...
class OpenWorldController extends AbstractActionController
{
    public function indexAction(): ViewModel
    {
        ...
        $games = CategoryGamesRetriever::execute(new OpenWorld(), $sort);

        $form = new SortByForm('grid-sort-by', ['action' => 'open-world', 'sort-by' => $sortBy]);
