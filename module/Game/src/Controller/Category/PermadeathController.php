...
class PermadeathController extends AbstractActionController
{
    public function indexAction(): ViewModel
    {
        ...
        $games = CategoryGamesRetriever::execute(new Permadeath(), $sort);

        $form = new SortByForm('grid-sort-by', ['action' => 'permadeath', 'sort-by' => $sortBy]);
