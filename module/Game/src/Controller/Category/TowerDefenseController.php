...
class TowerDefenseController extends AbstractActionController
{
    public function indexAction(): ViewModel
    {
        ...
        $games = CategoryGamesRetriever::execute(new TowerDefense(), $sort);

        $form = new SortByForm('grid-sort-by', ['action' => 'tower-defense', 'sort-by' => $sortBy]);
